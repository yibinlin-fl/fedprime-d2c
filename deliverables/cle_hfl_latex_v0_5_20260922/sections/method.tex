...
\evidenceneeded{M2 multi-training-seed stability for the matched HFL-versus-Local four-arm factorial. Seeds 1/2 are implemented but are not reported until Formal artifacts are returned and audited.}
