...
budget. Formal is now complete and independently audited: `NO_GO_CRSF_INTERVENTION`. Do not run
B-to-A, remaining architectures, tuning, replication or training integration.
