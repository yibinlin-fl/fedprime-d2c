...
def main() -> None:
    ...
    outputs_root = ROOT / f"outputs/cle_v2_spurious_final_map2_{args.mode}"
    configs_root = ROOT / f"local_runs/cle_v2_spurious_final_map2_{args.mode}_configs"
    analysis_root = ROOT / f"outputs/cle_v2_spurious_final_map2_{args.mode}_analysis"
    ...
    archive = package_light_outputs(
        ...
        configs_root,
        analysis_root,
        ROOT / f"cle_v2_spurious_final_map2_{args.mode}_outputs.tar.gz",
    )
