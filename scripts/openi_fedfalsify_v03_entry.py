...
CONFIG = "configs/openi_v100_fedfalsify_v03_probe.yaml"
EXPERIMENT = "probe_fedfalsify_v03_alpha05_gamma09_seed0"
DATASET_NAMES = (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="OpenI FedFalsify v0.3 candidate-only probe."
    )
...
def package_outputs() -> Path:
    archive_path = ROOT / "fedfalsify_v03_probe_outputs.tar.gz"
...
def main() -> None:
    ...
    log("===== OpenI FedFalsify v0.3 candidate-only probe =====")
    ...
    if not args.skip_train:
        log("===== Running FedFalsify v0.3 only; stored v0.2 control is reused offline =====")
    ...
    log("===== FedFalsify v0.3 probe complete =====")
