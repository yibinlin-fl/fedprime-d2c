...
OUT = ROOT / "deliverables" / "cle_hfl_latex_v0_2_20260916" / "figures"
...
def figure_one():
    ...
    box(d, xs[1], 173, w, h, "2  Shortcut-prone local training", ["robust local learning can still exploit binding"], RED, "OBSERVED FAILURE")
