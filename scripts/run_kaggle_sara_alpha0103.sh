...
RESULT_ARCHIVE="${RESULT_ARCHIVE:-/kaggle/working/sara_rahfl_alpha0103_results.tar.gz}"
...
echo "===== SARA + AsymHFL alpha=0.3/0.1 Kaggle launcher ====="
...
echo "===== Running SARA + AsymHFL alpha=0.3/0.1 experiments ====="
for cfg in "${CONFIGS[@]}"; do
  echo "===== Running ${cfg} ====="
