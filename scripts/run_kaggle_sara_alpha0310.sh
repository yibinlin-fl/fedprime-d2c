...
RESULT_ARCHIVE="${RESULT_ARCHIVE:-/kaggle/working/sara_rahfl_alpha0310_results.tar.gz}"
...
echo "===== SARA + AsymHFL alpha=0.3/1.0 Kaggle launcher ====="
...
echo "===== Running SARA + AsymHFL alpha=0.3/1.0 experiments ====="
for cfg in "${CONFIGS[@]}"; do
  echo "===== Running ${cfg} ====="
